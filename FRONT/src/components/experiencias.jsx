...
const Experiencias = () => {
    ...
    useEffect(() => {
        const fetchExperienciasVideos = async () => {
            try {
                const response = await axios.get(VIDEO_API_ENDPOINTS.EXPERIENCIAS);
                // Modificar los enlaces para que tengan el formato de enlace de compartir de YouTube
                ...
                console.error('Error al obtener los videos de la categoría "experiencias":', error);
            }
        };

        fetchExperienciasVideos();
    }, []);
