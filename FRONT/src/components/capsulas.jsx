...
const Capsulas = () => {
    ...
    useEffect(() => {
        const fetchCapsulasVideos = async () => {
            try {
                const response = await axios.get(VIDEO_API_ENDPOINTS.CAPSULAS); // Cambia la URL aquí
                ...
                console.error('Error al obtener los videos de la categoría "capsulas":', error);
            }
        };
